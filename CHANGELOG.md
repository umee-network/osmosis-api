...
* (<tag>) [#<PR-number>](https://github.com/umee-network/osmosis-api/pull/<PR-number>) <changelog entry>
...
## [<version>](https://github.com/umee-network/osmosis-api/releases/tag/<version>) - YYYY-MM-DD
